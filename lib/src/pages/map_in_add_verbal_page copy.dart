...
class Map_verbal_address_Sale_page extends StatefulWidget {
  const Map_verbal_address_Sale_page({
    super.key,
  ...
  final (double lat, double lon)? latLon;

  @override
  State<Map_verbal_address_Sale_page> createState() =>
      _SearchPlacesScreenState();
}

class _SearchPlacesScreenState extends State<Map_verbal_address_Sale_page> {
  String sendAddrress = '';
  ...
  LatLng latLng = const LatLng(11.575661, 104.922725);
